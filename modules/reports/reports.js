...
// ============================================================
import { sheetsBatchRead, parseSheetRows } from '../../sheets-api.js';
...
export async function renderProductionReport(container) {
  ...
  // Add product filter
  document.getElementById('rpt-extra-filters').innerHTML = `
    <label>Product</label>
  ...
  document.getElementById('rpt-run')?.addEventListener('click', async () => {
    const from = document.getElementById('rpt-from').value;
    const to   = document.getElementById('rpt-to').value;
    const prod = document.getElementById('rpt-product')?.value;
    ...
    document.getElementById('rpt-summary').style.display = '';
    document.getElementById('rpt-summary').innerHTML = `<div class="summary-pills">
    ...
    new DataTable(document.getElementById('rpt-table'), {
      columns: [
...
export async function renderInventoryReport(container) {
  ...
  document.getElementById('rpt-run')?.addEventListener('click', async () => {
    const from = document.getElementById('rpt-from').value;
    const to   = document.getElementById('rpt-to').value;
    const ing  = document.getElementById('rpt-ing')?.value;
...
export async function renderSalesReport(container) {
  ...
  document.getElementById('rpt-run')?.addEventListener('click', async () => {
    const from = document.getElementById('rpt-from').value;
    const to   = document.getElementById('rpt-to').value;
    const comp = document.getElementById('rpt-company')?.value;
...
export async function renderIngredientUsage(container) {
  ...
  document.getElementById('rpt-run')?.addEventListener('click', async () => {
    ...
    document.getElementById('rpt-summary').style.display = '';
    document.getElementById('rpt-summary').innerHTML = `<div class="summary-pills"><span class="pill">Ingredients Used: <strong>${data.length}</strong></span></div>`;
